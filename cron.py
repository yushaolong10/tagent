"""Durable cron scheduler that injects scheduled prompts."""
...
def save_durable_jobs():
    # Snapshot under the same lock used by schedule/cancel/scheduler.  The
    # JSON format stays unchanged; this only prevents inconsistent snapshots.
    with cron_lock:
